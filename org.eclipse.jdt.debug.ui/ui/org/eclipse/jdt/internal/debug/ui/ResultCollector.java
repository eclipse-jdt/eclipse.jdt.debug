...
//	private CompletionContext fContext;
	...
	protected IJavaCompletionProposal createMethodReferenceProposal(CompletionProposal methodProposal) {
		...
		JavaCompletionProposal proposal= new JavaCompletionProposal(completion, start, getLength(start, end), image, displayName, relevance);
	...
	protected IJavaCompletionProposal createMethodDeclarationProposal(CompletionProposal proposal) {
		...
		javaProposal.setImage(getImage(fLabelProvider.createImageDescriptor(proposal)));
	...
	protected IJavaCompletionProposal createAnnotationAttributeReferenceProposal(CompletionProposal proposal) {
		...
		String completion= String.valueOf(proposal.getCompletion());
		return new JavaCompletionProposal(completion, proposal.getReplaceStart(), getLength(proposal.getReplaceStart(), proposal.getReplaceEnd()), getImage(descriptor), displayString, proposal.getRelevance());
	}
