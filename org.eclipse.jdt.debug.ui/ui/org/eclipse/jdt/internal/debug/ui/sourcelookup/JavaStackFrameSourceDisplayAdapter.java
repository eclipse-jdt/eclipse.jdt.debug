...
public class JavaStackFrameSourceDisplayAdapter implements ISourceDisplay {
	...
	public void displaySource(Object element, IWorkbenchPage page, boolean forceSourceLookup) {
		...
		try {
			...
			if (sourceRes.getEditorInput() instanceof IClassFileEditorInput input) {
				if (openClassFileAndHighlightStackFrame(jdiFrame, input)) {
	...
	private boolean openClassFileAndHighlightStackFrame(JDIStackFrame jdiFrame, IClassFileEditorInput input) throws JavaModelException, PartInitException, DebugException {
