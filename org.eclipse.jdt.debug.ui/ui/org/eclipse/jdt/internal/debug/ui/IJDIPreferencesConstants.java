...
public interface IJDIPreferencesConstants {
	...
	public static final String PREF_COLORIZE_PLATFORM_METHODS = IJavaDebugUIConstants.PLUGIN_ID + ".colorize_platform_methods"; //$NON-NLS-1$
	public static final String PREF_COLORIZE_SYNTHETIC_METHODS = IJavaDebugUIConstants.PLUGIN_ID + ".colorize_synthetic_methods"; //$NON-NLS-1$
	public static final String PREF_COLORIZE_LIBRARY_METHODS = IJavaDebugUIConstants.PLUGIN_ID + ".colorize_library_methods"; //$NON-NLS-1$
