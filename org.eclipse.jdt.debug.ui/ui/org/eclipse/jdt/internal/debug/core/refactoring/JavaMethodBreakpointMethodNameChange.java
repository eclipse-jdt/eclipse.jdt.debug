...
public class JavaMethodBreakpointMethodNameChange extends Change {
	...
	public String getName() {
		return MessageFormat.format(RefactoringMessages.JavaMethodBreakpointMethodNameChange_0, new String[] {fDeclaringType.getElementName(), fOldMethodName}); 
	}
	...
	public RefactoringStatus isValid(IProgressMonitor pm) throws CoreException {
		...
		if (!fMethodBreakpoint.isRegistered()) {
			status.addFatalError(MessageFormat.format(RefactoringMessages.JavaMethodBreakpointMethodNameChange_1, new String[] {fDeclaringType.getElementName(), fOldMethodName})); 
		}
		return status;
	}
