...
public class ChildrenUpdateTests extends AbstractDebugTest {
	...
	public void testCoalesce () {
		...
		ChildrenUpdate update1 = new ChildrenUpdate(null, element, TreePath.EMPTY, element, 1, null, null);
		ChildrenUpdate update2 = new ChildrenUpdate(null, element, TreePath.EMPTY, element, 2, null, null);
		...
		update2 = new ChildrenUpdate(null, element, TreePath.EMPTY, element, 3, null, null);
		assertTrue("Should coalesce", update1.coalesce(update2));
		assertEquals("Wrong offset", 1, update1.getOffset());
		assertEquals("Wrong length", 3, update1.getLength());
		
		update2 = new ChildrenUpdate(null, element, TreePath.EMPTY, element, 2, null, null);
		assertTrue("Should coalesce", update1.coalesce(update2));
		assertEquals("Wrong offset", 1, update1.getOffset());
		assertEquals("Wrong length", 3, update1.getLength());		
		
		update2 = new ChildrenUpdate(null, element, TreePath.EMPTY, element, 5, null, null);
