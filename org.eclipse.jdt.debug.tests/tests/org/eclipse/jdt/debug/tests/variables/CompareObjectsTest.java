...
public class CompareObjectsTest extends AbstractDebugTest {
	...
	public void testForLis() throws Exception { // Test for Lists, Stack, Vector, ArrayLists
		...
		try {
			...
			result = objectComparision.compareSelectedLists(result);
			Map<String, String> compareResult = new HashMap<>();
			compareResult = (Map<String, String>) result.get(s1);
			String resultValue = compareResult.get("ImmediateResult");
			assertEquals("Object contains same elements as of s2 but in different order", resultValue);
			result.clear();
			...
			assertEquals("Element is actually missing - [apple1]", resultValue, "[apple1]");
			result.clear();
			...
			resultValue = o.toString();
			assertEquals("Element is actually missing - [22]", resultValue, "[22]");
			result.clear();
	...
	public void testForSets() throws Exception { // Test for Sets
		...
		try {
			...
			o = compareResult.get("ImmediateResult");
			resultValue = o.toString();
			assertEquals("Object contains same elements as of hashS2", resultValue);
			result.clear();
			...
			o = compareResult.get("ImmediateResult");
			resultValue = o.toString();
			assertEquals("Object contains same elements as of xx2", resultValue);
			result.clear();
	...
	public void testForArrayObjects() throws Exception { // Test for Arrays
		...
		try {
			...
			String resultValue = o.toString();
			assertEquals("Object contains same elements as of args1", resultValue);
			result.clear();
