...
public class ASTAPIVisitor extends ASTVisitor {
	 ...
	 * Constructor.
	 */
	public ASTAPIVisitor(int startPosition, String snippet) {
	...
	public boolean visit(ArrayAccess node) {
		...
		push(new org.eclipse.jdt.internal.debug.eval.ast.engine.ArrayAccess(fCounter));
...
//		node.getName().accept(this);
	...
	/**
	 * return false, doon't visit name, visit arguments
	 * 
