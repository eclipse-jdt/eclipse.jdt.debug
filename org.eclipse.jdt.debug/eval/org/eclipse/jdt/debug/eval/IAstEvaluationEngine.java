...
public interface IAstEvaluationEngine extends IEvaluationEngine {
	 ...
	 * @param evaluationDetail
	 *            bitmask of one of <code>DebugEvent.EVALUATION</code> or <code>DebugEvent.EVALUATION_IMPLICIT</code> and optionally
	 *            <code>DISABLE_GC_ON_RESULT</code>
	 * @param hitBreakpoints
	 *            whether or not breakpoints should be honored in the evaluation thread during the evaluation. If <code>false</code>, breakpoints hit
	 ...
	 *                <li>The associated thread is suspended in the middle of an evaluation that has not completed. It is not possible to perform
	 *                nested evaluations</li>
	 *                </ul>
	 * @since 3.22
	 */
	public void evaluateExpression(ICompiledExpression expression,
